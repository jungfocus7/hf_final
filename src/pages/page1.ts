...
<div class="c_btc">
    ...
    <button type="button" class="c_bt"><span>03)hfarr</span></button>
        ...
        const fn_btnClick0 = (e: Event = null!): void => {
            rt.fn_print();
        };
        btns[0].addEventListener(eventTypes.CLICK, fn_btnClick0);

        const fn_btnClick1 = (e: Event = null!): void => {
            rt.fn_print('{{------------------------------  hfnum');

            const fn_print_isNum = (val: unknown): void => {
            ...
            const fn_print_notNum = (val: unknown): void => {
            ...
            const fn_print_isFloat = (val: number): void => {
            ...
            const fn_print_isMinus = (val: number): void => {
            ...
            const fn_print_randRange = (min: number, max: number): void => {
            ...
            const fn_print_isOdd = (val: number): void => {
            ...
            const fn_print_isEven = (val: number): void => {
        ...
        const fn_btnClick2 = (e: Event = null!): void  => {
            rt.fn_print('{{------------------------------  hfstr');

            const fn_print_isStr = (val: unknown): void => {
            ...
            const fn_print_notStr = (val: unknown): void => {
            ...
            const fn_print_getLastNum = (val: string): void => {
            ...
            const fn_print_str2Ab = (val: string): void => {
            ...
            const fn_print_ab2Str = (ab: Uint16Array): void => {
        ...
        const fn_btnClick3 = (e: Event = null!): void  => {
            rt.fn_print('{{------------------------------  hfarr');

            const fn_print_isArr = (arr: unknown): void => {
            ...
            const fn_print_notArr = (arr: unknown): void => {
            ...
            const fn_print_contains = (arr: Array<unknown>, e: unknown): void => {
            ...
            const fn_print_shuffle = (arr: Array<unknown>): void => {
            ...
            const fn_print_copy = (arr: Array<unknown>): void => {
...
export const _page1: IPage1 = Object.seal({
    rootContainer: null!,
